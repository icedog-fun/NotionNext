...
module.exports = {
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE || 'lei', // 文章类型，
    type_post: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_POST || '文', // 当type文章类型与此值相同时，为博文。
    type_page: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_PAGE || 'ye', // 当type文章类型与此值相同时，为单页。
    type_notice:
